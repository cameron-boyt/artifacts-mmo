...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param({ "cooked_hellhound_meat": 1 }, 100, "cooked_hellhound_meat", id="one_food_in_bank__heals_more_than_max_hp"),
        pytest.param({ "cooked_gudgeon": 1, "cooked_chicken": 1 }, 100, "cooked_chicken", id="multiple_food_in_bank"),
        pytest.param({ "cooked_gudgeon": 1, "cooked_hellhound_meat": 1 }, 100, "cooked_gudgeon", id="multiple_food_in_bank__heals_more_than_max_hp"),
    ]
)
